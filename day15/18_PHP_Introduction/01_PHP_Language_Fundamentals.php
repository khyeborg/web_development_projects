<?php
  ...
  // The string delimiter used determines how much "work" a string will do in terms of evaluating
  ...
  // you can cast between data types using Java-style casting syntax, like this:
  print "<hr>";
  $var3_a = "572";
  var_dump( $var3_a );
  print "<br>";
